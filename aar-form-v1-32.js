	...
	var ta = function ()
		{
			...
			},
			{
				...
				key: "removeClassFromNext",
				value: function ()
				{
					this.view.inputs.forEach(function ()
					{
						input.addEventListener("input", function() {
							...
							{
								var nextBtn = document.getElementById("aar-next");
			...
			,
			{
				...
				value: function ()
				{
					this.checkRequiredInputs() ? (this.currentStep++, 1 === this.currentStep && this.view.enableElement(this.view.back), this.currentStep === this.view.steps.length ? this.view.submitForm() : (this.view.goNext(), this.view.removeClassFromNext(), this.view.setMaskHeight(this.currentStep), this.view.setButtonText(this.currentStep), this.view.showSteps(), this.view.setStepsDisplay(this.currentStep)), this.hideAlert(), this.view.scrollTop()) : this.showAlert()
				}
			},
			{
				key: "backClick",
				value: function ()
				{
					...
					e < 0 || (this.view.goBack(), this.view.setMaskHeight(e), this.view.setButtonText(e), this.view.setStepsDisplay(e), this.hideAlert(), this.view.scrollTop(), this.currentStep = e, 0 === this.currentStep && (this.view.disableElement(this.view.back), this.view.hideSteps()))
				}
			},
			{
				key: "navClick",
	...
	var xa = function ()
		{
			...
			},
			{
				...
				value: function ()
				{
					...
					var btnNext = document.getElementById("aar-next");
					btnNext.classList.add("next-slide")
				}
			},
			{
				key: "goBack",
