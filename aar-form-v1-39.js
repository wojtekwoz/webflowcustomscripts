	...
	var ta = function ()
		{
			...
			},
			{
                ...
                key: "observechangeoninput",
                value: function () {  
                    var nextBtn = document.getElementById("aar-next");
                    var e = this;
                    this.view.getInputs(this.currentStep).forEach(function (t) {
	...
	var xa = function ()
		{
			...
			return wa(e, [
			{
				...
				value: function (e)
				{
					this.mask.style.height = "100%", this.mask.style.height = "100%".concat(this.steps[e].offsetHeight, "px")
				}
			},
			{
				key: "getInputs",
			...
			},
			{
				...
				value: function ()
				{
                    ...
                    this.view.observechangeoninput(this.currentStep);
				}
			},
			{
				key: "goBack",
			...
			{
				key: "observeIfInputsHaveValue",
				value: function ()
				{
                    let button = document.getElementById("aar-next")
