...
(function() {
    ...
    var ta = function() {
            ...
            return sa(e, [{
                ...
                key: "nextClick",
                value: function() {
                    var stepWrap = $("#step-wrap");
                    this.checkRequiredInputs() ? (this.currentStep++, 1 === this.currentStep && stepWrap.style.remove("is--hidden"), this.view.enableElement(this.view.back), this.currentStep === this.view.steps.length ? this.view.submitForm() : (this.view.goNext(), this.view.setMaskHeight(this.currentStep), this.view.setButtonText(this.currentStep), this.view.setStepsDisplay(this.currentStep)), this.hideAlert(), this.view.scrollTop()) : (this.showAlert(), this.view.disableElement(this.next))
                }
            }, {
                key: "backClick",
                value: function() {
                    ...
                    e < 0 || (this.view.goBack(), this.view.setMaskHeight(e), this.view.setButtonText(e), this.view.setStepsDisplay(e), this.hideAlert(), this.view.scrollTop(), this.currentStep = e, 0 === this.currentStep && this.view.disableElement(this.view.back), stepWrap.style.add("is--hidden"))
                }
            }, {
                key: "navClick",
                value: function(e) {
