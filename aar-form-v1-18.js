			...
			},
			{
				...
				value: function ()
				{
					...
					}), this.view.inputs.forEach(function (e)
					{
                        ...
                        e.addEventListener("change", checkRequiredInputsTwo);
	...
	var xa = function ()
		{
			...
			},
			{
				...
				value: function (e)
				{
                    ...
                    var t = document.querySelector("#aar-next");
                    t.classList.add("aar-next-disabled")
				}
			},
			{
				...
				value: function (e)
				{
                    ...
                    var t = document.querySelector("#aar-next");
                    t.classList.remove("aar-next-disabled")
				}
			},
			{
				key: "hideElement",
