	...
	var ta = function ()
		{
			...
			},
			{
				...
				{
					var e = this,
                        checkIfAllInputsAreValid = function(){ 
                            var isNextButton  = document.getElementById("aar-next");
                            var isValid = isNextButton.classList.remove("button-disabled");;
                            for(var i = 0; i < e.view.inputs.length; i++){
                                if(!e.view.inputs[i].valid){
                                    isNextButton.classList.add("button-disabled");
                                    break;
                                }
                            }
                            return isValid;
					...
					}), this.view.inputs.forEach(function (e)
					{
                        ...
                        e.addEventListener("change", checkIfAllInputsAreValid);
