	...
	var ta = function ()
		{
			...
			return sa(e, [
			{
				...
				value: function ()
				{
					this.view.setMaskHeight(this.currentStep), this.view.disableElement(this.view.back), this.view.setButtonText(this.currentStep), this.view.setStepsDisplay(this.currentStep), this.view.createHiddenForm(), this.setAlert(), this.setEvents(), this.view.hideSteps()
				}
			},
			{
				key: "setEvents",
			...
			},
			{
				...
				value: function ()
				{
					this.checkRequiredInputs() ? (this.currentStep++, 1 === this.currentStep && this.view.enableElement(this.view.back), this.currentStep === this.view.steps.length ? this.view.submitForm() : (this.view.removeDisableClass(), this.view.goNext(), this.view.setMaskHeight(this.currentStep), this.view.setButtonText(this.currentStep), this.view.addDisableClass(), this.view.showSteps(), this.view.setStepsDisplay(this.currentStep)), this.hideAlert(), this.view.scrollTop()) : this.showAlert()
				}
			},
			{
				key: "backClick",
				value: function ()
				{
					...
					e < 0 || (this.view.goBack(), this.view.setMaskHeight(e), this.view.setButtonText(e), this.view.addDisableClass(), this.view.setStepsDisplay(e), this.hideAlert(), this.view.scrollTop(), this.currentStep = e, 0 === this.currentStep && this.view.disableElement(this.view.back) && this.view.hideSteps())
				}
			},
			{
				key: "navClick",
			...
			},
			{
				...
				value: function ()
				{
					this.view.disableButtons(), this.view.hideButtons(), this.view.hideSteps()
				}
			}]), e
		}(),
		ua = ta;
	...
	var xa = function ()
		{
			...
			},
			{
				...
				value: function ()
				{
					this.submitButton.click(), this.view.hideSteps()
				}
			},
			{
			...
			},
            {
				...
				value: function (e)
				{
                    var e = document.querySelector("#step-wrap");
                    e.style.opacity = "0";
				}
			},
            {
...

            {
				...
				value: function (e)
				{
                    var e = document.querySelector("#aar-next");
                    e.classList.add("btn--disabled")
				}
			},
            {
				key: "removeDisableClass",
				value: function (e)
				{
                    var e = document.querySelector("#aar-next");
