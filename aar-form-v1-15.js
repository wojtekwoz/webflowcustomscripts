	...
	var ta = function ()
		{
			...
			},
			{
				...
				value: function ()
				{
					...
					e < 0 || (0 === this.currentStep && (this.view.disableElement(this.view.back), this.view.hideSteps()) ,this.view.goBack(), this.view.setMaskHeight(e), this.view.setButtonText(e), this.view.setStepsDisplay(e), this.hideAlert(), this.view.scrollTop(), this.currentStep = e);
				}
			},
			{
				key: "navClick",
